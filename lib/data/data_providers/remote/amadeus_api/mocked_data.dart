...
class AmadeusMockedDataProvider implements AmadeusBaseDataProvider {
  Future<T> simulateRemoteDataDelay<T>(T data) {
    return Future.delayed(Duration(milliseconds: 0), () => data);
  }
